...
public class DescriptionScreen extends Activity {
	...
	private static final int HIGHER_LIMIT_YELLOW_BAR = 5000; // Measured in
																// Real.
	...
	public void requestQuotas() {
		Log.e("Entrei no meodo requestCongressman",
				"Entrei no metodo requestCongressman");
	 ...
	 */
	private void setSizeQuotasBar(ImageView bar, String quota, double valueQuota) {
	...
	/**
	 * Return the ID of a image resource by a string, that representing a
	 * resource.
	 * <p>
	 * 
	 * @param typeResource
