 ...
 */
	...
	/**
	 * Set the message text for this dialog's window. The text is
	 * retrieved from the resources with the supplied
	 * @param messageId
	 * 		- the message text resource identifier 
	 */
	
	public void setMessage(int messageId){
		this.message.setText(this.context.getResources().getString(messageId));
		this.message.setMovementMethod(ScrollingMovementMethod.getInstance());
	}
}
